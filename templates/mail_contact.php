...
<table border="0" cellpadding="0" cellspacing="0" role="presentation"
    ...
    <tr>
        <td>
            ...
            <!-- Header (logo) -->
            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;margin-top: 30px;" width="100%">
                <tr>
                    <td style="padding-left:15px;padding-right:15px;width:100%;padding-bottom:5px;" align="center">
                        <div style="line-height:10px">
                            <a href="" style="outline:none" target="_blank">
                                <img class="photo" alt="Blog Logo" src="/assets/img/otter.png" title="OtterBlog"
                                     width="123px"/>
                            </a>
                        </div>
                    </td>
            ...
            <table border="0" cellpadding="10" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td>
                        <div style="margin: 0; margin-top: 25px; color: #2b2d2d; font-weight: normal; letter-spacing: normal; line-height: 120%;"
                             align="center">
                            <h1>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-10" role="presentation"
                   style="margin-top:35px;mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #090660;"
                   width="100%">
                <tbody>
                <tr>
                    <td>
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 2px 0 2px;"><a
                                                                    href="https://www.twitter.com/"><img alt="Twitter"
                                                                                                         height="32"
                                                                                                         src="/assets/img/twitter2x.png"
                                                        ...
                                                        <td style="padding:0 2px 0 2px;"><a
                                                                    href="https://www.facebook.com/"><img alt="Facebook"
                                                                                                          height="32"
                                                                                                          src="/assets/img/facebook2x.png"
                                                                                                          style="display: block; height: auto; border: 0;"
                                                                                                          title="facebook"
                                                                                                          width="32"/></a>
                                                        </td>
                                                        <td style="padding:0 2px 0 2px;"><a href=""><img alt="GitHub"
                                                                                                         height="32"
                                                                                                         src="/assets/img/gh-white-icon.png"
                                                                                                         style="display: block; height: auto; border: 0;"
                                                                                                         title="github"
                                                                                                         width="32"/></a>
                                                        </td>
